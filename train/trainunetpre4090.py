...
if __name__ == "__main__":
    ...
    args.add_argument('-c', '--checkpoint', default='segmentattention/train/checkpoints', type=str,
    ...
    for epoch in range(cmd_args.epochs):
        ...
        if valid_perf > max_perf:
            ...
            torch.save(model.state_dict(), cmd_args.checkpoint + '/unet_resnet18_epoch_' + str(epoch) +
